...
--
-- Table structure for table `nationalitaet`
--
...
--
-- Dumping data for table `nationalitaet`
--

LOCK TABLES `nationalitaet` WRITE;
/*!40000 ALTER TABLE `nationalitaet` DISABLE KEYS */;
INSERT INTO `nationalitaet` VALUES (3,'Ã„gyptisch'),(4,'Brasilianisch'),(5,'Chinesisch'),(1,'Deutsch'),(2,'FranzÃ¶sisch'),(7,'Kroatisch'),(6,'RumÃ¤nisch');
